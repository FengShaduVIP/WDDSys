...
public interface CommonConstant {
    ...
    public static final Integer SC_INTERNAL_SERVER_ERROR_500 = 501;
    ...
    */
    ...
    /***************************************微信小程序***********************************************/
    /**
     * 微信小程序用户等级 0 普通登陆用户 1 商家 2 运营 3管理员
     */
    public static final int WXAPP_USER_LEVEL_0 = 0;
    public static final int WXAPP_USER_LEVEL_1 = 0;
    public static final int WXAPP_USER_LEVEL_2 = 0;
    public static final int WXAPP_USER_LEVEL_3 = 0;


    /**
     * 微信小程序 系统微信号 几位
     */
    public static final int WXAPP_USER_WXNO_SIZE = 6;
}
