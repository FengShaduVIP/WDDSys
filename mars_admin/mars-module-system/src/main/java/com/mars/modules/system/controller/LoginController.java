...
import com.mars.modules.shiro.vo.CodeDTO;
import com.mars.modules.system.entity.SysDepart;
import com.mars.modules.system.entity.SysUser;
import com.mars.modules.system.model.SysLoginModel;
import com.mars.modules.system.service.ISysLogService;
...
import com.mars.common.util.DySmsHelper;
import com.mars.common.util.PasswordUtil;
import com.mars.common.util.RedisUtil;
import com.mars.common.util.encryption.AesEncryptUtil;
import com.mars.common.util.encryption.EncryptedString;
import com.mars.common.util.oConvertUtils;
import com.mars.modules.shiro.vo.DefContants;
import com.mars.modules.system.service.ISysDepartService;
...
public class LoginController {
	...
	public Result wxlogin(@RequestBody @Validated CodeDTO codeDTO) throws Exception {
		try {
			return Result.ok(wxUserService.wxUserLogin(codeDTO.getCode()));
		}catch (Exception e){
			log.info("微信小程序用户登陆失败");
			log.error(e.toString());
			return Result.error("微信小程序用户登陆失败");
		}
	}
