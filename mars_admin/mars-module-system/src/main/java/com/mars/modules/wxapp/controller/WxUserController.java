...
public class WxUserController {
	 ...
	 * @return
	 */
	@AutoLog(value = "微信小程序用户-分页列表查询")
	@ApiOperation(value="微信小程序用户-分页列表查询", notes="微信小程序用户-分页列表查询")
	 ...
	 * @return
	 */
	@AutoLog(value = "微信小程序用户-添加")
	@ApiOperation(value="微信小程序用户-添加", notes="微信小程序用户-添加")
	 ...
	 * @return
	 */
	@AutoLog(value = "微信小程序用户-编辑")
	@ApiOperation(value="微信小程序用户-编辑", notes="微信小程序用户-编辑")
	 ...
	 * @return
	 */
	@AutoLog(value = "微信小程序用户-通过id删除")
	@ApiOperation(value="微信小程序用户-通过id删除", notes="微信小程序用户-通过id删除")
	 ...
	 * @return
	 */
	@AutoLog(value = "微信小程序用户-批量删除")
	@ApiOperation(value="微信小程序用户-批量删除", notes="微信小程序用户-批量删除")
	 ...
	 * @return
	 */
	@AutoLog(value = "微信小程序用户-通过id查询")
	@ApiOperation(value="微信小程序用户-通过id查询", notes="微信小程序用户-通过id查询")
  ...
  public ModelAndView exportXls(HttpServletRequest request, HttpServletResponse response) {
      ...
      //导出文件名称
      mv.addObject(NormalExcelConstants.FILE_NAME, "微信小程序用户列表");
      mv.addObject(NormalExcelConstants.CLASS, WxUser.class);
      mv.addObject(NormalExcelConstants.PARAMS, new ExportParams("微信小程序用户列表数据", "导出人:Jeecg", "导出信息"));
