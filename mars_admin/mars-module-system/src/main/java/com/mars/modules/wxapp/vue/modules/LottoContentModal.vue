  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/wxapp/lottoContent/add",
          edit: "/wxapp/lottoContent/edit",
        },
      }
    },
    created () {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'lottoNo','lottoId','type','content','sort','status'))
		  //时间格式化
        });
